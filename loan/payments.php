				...
				<table class="table table-bordered" id="loan-list">
					...
					<tbody>
						<?php
							...
							$qry = $conn->query("SELECT p.*,l.ref_no,owner as name,owner as contact_no, owner as address from payments p inner join loan_list l on l.id = p.loan_id inner join properties b on b.propertyid = l.borrower_id  order by p.id asc");
