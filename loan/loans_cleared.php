				...
				<table class="table table-bordered" id="loan-list">
					...
					<tbody>
						<?php
							...
							$qry = $conn->query("SELECT l.*,owner as name, owner as contact_no, owner as address from loan_list l inner join properties b on b.propertyid = l.borrower_id where l.status='5' order by id asc");
